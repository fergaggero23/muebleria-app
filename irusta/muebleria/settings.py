...
SECRET_KEY = 'django-insecure-mstdrvq4w4-quwoh%35uukc-%jb*7q4^$#(=jphw*6z%9*!x^o'
...
JAZZMIN_SETTINGS = {
    "site_title": "Mueblería Admin",
    "site_header": "Control de Mueblería",
    "welcome_sign": "Bienvenido al sistema de gestión",
    "copyright": "Mueblería S.A.",
    "show_sidebar": True,
